...
32 testes backend, E2E de missão até promoção na demo, regressão de UI (36 combinações) e smoke IA real passaram. Guias PT/EN/ES atualizados. Serviço local v1.2.0 em http://127.0.0.1:8765/app/, backup privado do banco antes da migração. Site público segue demonstração SEM IA; versão local gera conteúdo real.

URLs existentes preservadas: https://inematds.github.io/rsi-copiloto/app/ e /guia/. O portal já aponta para esse guia; nenhuma nova entrada é necessária. Atualização publicada pelo origin inematds/rsi-copiloto (145730d), Actions verde, HTTP 200 e fluxo completo de missão/LOOP-R testado também no site público. Sem edições nos checkouts compartilhados de portal/busca/PRO nesta atualização.
